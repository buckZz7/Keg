...
class Recipe(BaseModel):
    ...
    # WHERE the actual file lives — the house VERIFIES it (fetches from here,
    # hashes, confirms it matches model_sha256), so it has accuracy enforcement.
    source: str = Field(default="", description="URL/repo where the actual model file is hosted (house-verified against the hash)")
